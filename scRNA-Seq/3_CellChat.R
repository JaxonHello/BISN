...
Run_CellChat_Merged_Plot <- function(cellchat01, cellchat02, ) {
...
cellchat_merged <- mergeCellChat(list(AD1_cc, Control2_cc),
...
netAnalysis_signalingChanges_scatter(cellchat_merged, idents.use = "Macrophage", signaling.exclude = "MIF")


gg1 <- netVisual_bubble(cellchat_merged,
                        sources.use = "Macrophage", targets.use = levels(cellchat_merged@idents),
