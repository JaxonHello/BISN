...
##### Merge analysis test #####
AD1_cc <- readRDS("V01/CellChat_single/AD1/cellchat_AD1.rds")
AD3_cc <- readRDS("V01/CellChat_single/AD3/cellchat_AD3.rds")
AS1_cc <- readRDS("V01/CellChat_single/AS1/cellchat_AS1.rds")
Control2_cc <- readRDS("V01/CellChat_single/Control2/cellchat_Control2.rds")
